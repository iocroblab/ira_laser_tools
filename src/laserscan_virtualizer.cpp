...
LaserscanVirtualizer::LaserscanVirtualizer()
{
    ...
    point_cloud_subscriber_ = node_.subscribe<sensor_msgs::PointCloud2> (cloud_topic.c_str(), 1, boost::bind(&LaserscanVirtualizer::pointCloudCallback, this, boost::placeholders::_1));
	cloud_frame = "";
}
...
int main(int argc, char** argv)
{
    ...
    f = boost::bind(&LaserscanVirtualizer::reconfigureCallback,&_laser_merger, boost::placeholders::_1, boost::placeholders::_2);
